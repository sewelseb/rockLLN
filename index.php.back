...
<!-- header -->
					<header>
						<!--<h1><a href="index.html" id="logo">Soirée fragrance</a></h1>-->
						<h1 ><a href="index.php" class="titreH1">Soirée <br/>Fragrances</a></h1>
						<nav>
							<ul id="menu">
								<li><a href="#!/page_Repondre"><span></span><strong>Répondre</strong></a></li>
								<li><a href="#!/page_About"><span></span><strong>Plan d'accès</strong></a></li>
								<li><a href="#!/page_Portfolio"><span></span><strong>Photos</strong></a></li>
								<li><a href="#!/page_Services"><span></span><strong>Le thème</strong></a></li>
									...
									<div class="inner">
										...
										<div class="wrapper pad_bot1">
											...
											<div>
												...
												<form id="formulaireDeReponse" action="EnregistrementReponse.php" method="POST" >
													<table>
														<tr>
															<td>
																Titre:
															...
															<td>
																<input name="titre" id="titre" required>
															</td>
														</tr>
														<tr>
															<td>	
														...
														<tr>
															<td>	
																Présence à la soirée:
															</td>
															<td>
																<input type="radio" name="presence" id="presence" value="true"> Je viens à la soirée </input> <br/>
																<input type="radio" name="presence" id="presence" value="false"> Je  ne viens pas à la soirée </input>
															</td>
														</tr>
														<tr>
															<td>	
															...
															<td>
																<textarea name="message" id="message" row="400" cols="50">
																</textarea>
															</td>
														</tr>
														<tr>
							...
							<li id="page_About">
								<div class="box1">
									<div class="inner">
										...
										<h2>Plant d'accès</h2>
										 	<p>
										 		<strong>Adresse </strong>: Rue Haute 8, 1460 Ittre 
							 				</p>
<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2529.7734754877506!2d4.262733000000007!3d50.64989799999998!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x47c3cb9ba0abea11%3A0x141a62caedccda86!2sPalais+de+Plume!5e0!3m2!1sfr!2s!4v1397118753833" width="600" height="450" frameborder="0" style="border:0"></iframe>							 				
									</div>
								</div>
							</li>
									...
									<div class="inner">
										...
										<div class="wrapper tabs">
											<div class="col1">
												<h2>Catégories</h2>
												<ul class="nav">
													<li class="selected"><a href="#Fragrance"><span></span><strong>Fragrances</strong></a></li>
													<li><a href="#Ambiance"><span></span><strong>Ambiance</strong></a></li>
													<li><a href="#Coctail"><span></span><strong>Cocktail</strong></a></li>
													<li><a href="#Dinner"><span></span><strong>Dîner</strong></a></li>
													<li><a href="#Soirée"><span></span><strong>Soirée</strong></a></li>
													
												</ul>
											</div>
											<div class="col2 pad_left1">
												<div class="tab-content" id="Fragrance">
													<h2>Fragrances</h2>
													<div class="wrapper">
														<figure  class="left marg_right1"><a href="images/large_640x.jpg" class="lightbox-image" data-type="prettyPhoto[group2]"><span></span><img src="images/large_640x.jpg" alt="" width="202" height="128"></a></figure>
														<figure class="left"><a href="images/Chanelno5-carole-bouquet-dominique-issemann-1997.jpg" class="lightbox-image" data-type="prettyPhoto[group2]"><span></span><img src="images/Chanelno5-carole-bouquet-dominique-issemann-1997.jpg" alt="" width="202" height="128"></a></figure>
													</div>
													<div class="wrapper">
														<figure class="left marg_right1"><a href="images/7e0ad2ef-8b44-4edf-96d4-06a87db1e3e1_bg.jpg" class="lightbox-image" data-type="prettyPhoto[group2]"><span></span><img src="images/7e0ad2ef-8b44-4edf-96d4-06a87db1e3e1_bg.jpg" alt="" width="202" height="128"></a></figure>
														<figure class="left"><a href="images/Gucci-Premiere.jpeg" class="lightbox-image" data-type="prettyPhoto[group2]"><span></span><img src="images/Gucci-Premiere.jpeg" alt="" width="202" height="128"></a></figure>
													</div>
													<div class="wrapper">
														<figure class="left marg_right1"><a href="images/02eac4265cddeeafafd949575b1fe79e.jpg" class="lightbox-image" data-type="prettyPhoto[group2]"><span></span><img src="images/02eac4265cddeeafafd949575b1fe79e.jpg" alt="" width="202" height="128"></a></figure>
														<figure class="left"><a href="images/1339175470_alexander-skarsgard-zoom.jpg" class="lightbox-image" data-type="prettyPhoto[group2]"><span></span><img src="images/1339175470_alexander-skarsgard-zoom.jpg" alt="" width="202" height="128"></a></figure>
													</div>
													<div class="wrapper">
														<figure class="left marg_right1"><a href="images/no5_ad_visual.jpg" class="lightbox-image" data-type="prettyPhoto[group2]"><span></span><img src="images/no5_ad_visual.jpg" alt="" width="202" height="128"></a></figure>
														<figure class="left"><a href="images/Paco-Rabanne-Lady-Million-EDP-80-ml_za10_o_3.jpg" class="lightbox-image" data-type="prettyPhoto[group2]"><span></span><img src="images/Paco-Rabanne-Lady-Million-EDP-80-ml_za10_o_3.jpg" alt="" width="202" height="128"></a></figure>
													</div>
													<div class="wrapper">
														<figure class="left marg_right1"><a href="images/paltrow-hugoboss.jpg" class="lightbox-image" data-type="prettyPhoto[group2]"><span></span><img src="images/paltrow-hugoboss.jpg" alt="" width="202" height="128"></a></figure>
														<figure class="left"><a href="images/mark-ronson-fendi-fragrance-fan-di-fendi-pour-homme-ad__oPt.jpg" class="lightbox-image" data-type="prettyPhoto[group2]"><span></span><img src="images/mark-ronson-fendi-fragrance-fan-di-fendi-pour-homme-ad__oPt.jpg" alt="" width="202" height="128"></a></figure>
													</div>
												</div>
							...
							<li id="page_Services">
								<div class="box1">
									<div class="inner">
										...
										<div class="wrapper pad_bot3">
											<figure class="left marg_right1"><iframe width="250" height="170" src="//www.youtube.com/embed/aTbG1hG2AFA" frameborder="0" allowfullscreen></iframe></figure>
											<p class="color1 pad_bot2"><strong>Dior Homme</strong></p>
											<p>Dior Homme Fragrance Uncensored Director's Cut starring Robert Pattinson, directed by Romain Gavras. Music by Led Zeppelin.</p>
										</div>
										<div class="wrapper pad_bot3">
											<figure class="left marg_right1"><iframe width="250" height="170" src="//www.youtube.com/embed/7K2GAoBTuc4" frameborder="0" allowfullscreen></iframe></figure>
											<p class="color1 pad_bot2"><strong>Gucci Guilty</strong></p>
											<p>Gucci Guilty</p>
										</div>
										<div class="wrapper pad_bot3">
											<figure class="left marg_right1"><iframe width="250" height="170" src="//www.youtube.com/embed/Q8lxGGx0R04" frameborder="0" allowfullscreen></iframe></figure>
											<p class="color1 pad_bot2"><strong>INVICTUS - Paco Rabanne </strong></p>
											<p>Paco Rabanne presents Invictus TV spot. The commercial by Alexandre Courtès.</p>
										</div>
										<div class="wrapper pad_bot3">
											<figure class="left marg_right1"><iframe width="250" height="170" src="//www.youtube.com/embed/4VPHVygoca4" frameborder="0" allowfullscreen></iframe></figure>
											<p class="color1 pad_bot2"><strong>Paco Rabanne - 1 Million</strong></p>
											<p>Paco Rabanne - 1 Million</p>
										</div>
										...
										<div class="wrapper">
											<div class="col1">
												...
												<p>+02 762 69 77<br>
														...
														<a href="mailto:" class="link1">xdb@live.be</a></p>
...
<!-- footer -->
				<footer>
					...
					<div class="col_1">
						<!--<a href="index.html" id="footer_logo">Sébastien de Beauffort</a>-->
					</div>
					<div class="col_2">
						Developed by <a rel="nofollow" href="http://www.qwerteach.com/index.php?page=profil&profil=sebastien" target="_blank">Sébastien de Beauffort</a>
						<!-- {%FOOTER_LINK} -->
					</div>
				</footer>
<!-- / footer-->
